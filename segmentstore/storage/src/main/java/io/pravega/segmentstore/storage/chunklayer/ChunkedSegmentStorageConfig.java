...
public class ChunkedSegmentStorageConfig {
    public static final Property<Long> MIN_SIZE_LIMIT_FOR_CONCAT = Property.named("storage.concat.minSize", 0L);
    public static final Property<Long> MAX_SIZE_LIMIT_FOR_CONCAT = Property.named("storage.concat.maxSize", Long.MAX_VALUE);
    public static final Property<Integer> MAX_BUFFER_SIZE_FOR_APPENDS = Property.named("storage.appends.bufferSize", 1024 * 1024);
    public static final Property<Integer> MAX_INDEXED_SEGMENTS = Property.named("storage.readindex.maxSegments", 1024);
    public static final Property<Integer> MAX_INDEXED_CHUNKS_PER_SEGMENTS = Property.named("storage.readindex.maxChunksPerSegment", 1024);
    public static final Property<Integer> MAX_INDEXED_CHUNKS = Property.named("storage.readindex.maxChunks", 16 * 1024);
    public static final Property<Boolean> APPEND_DISABLED = Property.named("storage.appends.disabled", false);
    public static final Property<Long> DEFAULT_ROLLOVER_SIZE = Property.named("writer.rollover.size.bytes.max", SegmentRollingPolicy.MAX_CHUNK_LENGTH);
    ...
    static final String COMPONENT_CODE = "pravegaservice";
