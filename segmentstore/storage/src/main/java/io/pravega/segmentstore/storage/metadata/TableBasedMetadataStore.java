...
public class TableBasedMetadataStore extends BaseMetadataStore {
    ...
    protected CompletableFuture<Void> writeAll(Collection<TransactionData> dataList) {
        ...
        HashMap<TableEntry, TransactionData> entryToTxnDataMap = new HashMap<>();
        HashMap<TableKey, TransactionData> deletedKeyToTxnDataMap = new HashMap<>();
    ...
    private StorageMetadataException handleException(Throwable e) {
