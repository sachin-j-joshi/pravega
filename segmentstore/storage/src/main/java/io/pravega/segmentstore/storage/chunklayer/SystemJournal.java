...
public class SystemJournal {
     ...
     */
    private byte[] getContents(String snapshotFile) throws ChunkStorageException, ExecutionException, InterruptedException {
    ...
    private void applySystemLogOperations(MetadataTransaction txn,
                                          ...
                                          HashMap<String, Long> finalFirstChunkStartsAtOffsets) throws Exception, IOException, StorageMetadataException {
     ...
     */
    private void adjustLastChunkLengths(MetadataTransaction txn) throws StorageMetadataException, ChunkStorageException, InterruptedException, ExecutionException {
        for (String systemSegment : systemSegments) {
     ...
     */
    private void writeToJournal(ByteArraySegment bytes) throws ChunkStorageException, ExecutionException, InterruptedException {
     ...
     * @throws ChunkStorageException
     */
    private void startNewJournalFile() throws ChunkStorageException, ExecutionException, InterruptedException {
        currentFileIndex++;
