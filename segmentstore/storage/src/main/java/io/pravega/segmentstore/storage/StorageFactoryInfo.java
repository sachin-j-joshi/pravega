...
public class StorageFactoryInfo {
    ...
    /**
     * Type of {@link io.pravega.segmentstore.storage.chunklayer.ChunkStorageManager} supported.
     */
    StorageManagerType storageManagerType;

    /**
     * Type of {@link io.pravega.segmentstore.storage.chunklayer.ChunkStorageManager} layout supported.
     */
