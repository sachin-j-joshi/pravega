...
public class ChunkedSegmentStorage implements Storage {
    ...
    private void claimOwnership(MetadataTransaction txn, SegmentMetadata segmentMetadata) throws ChunkStorageException, StorageMetadataException {
        ...
        ChunkNotFoundException exception = null;
        if (null != lastChunkName) {
            ...
            try {
                ...
                // This probably means that this instance is fenced out.
                // Try a commit of unmodified data
                log.debug("{} claimOwnership - Last chunk was missing - segment={}, last chunk={}.",
                        logPrefix,
                        segmentMetadata.getName(),
                        lastChunk.getName());
