...
public class ChunkedSegmentStorageConfigTests {
    ...
    public void testProvidedValues() {
        ...
        props.setProperty(ChunkedSegmentStorageConfig.READ_BLOCK_SIZE.getFullName(ChunkedSegmentStorageConfig.COMPONENT_CODE), "17");
        ...
        Assert.assertEquals(config.getReadBlockSize(), 17);
    }
    ...
    private void testDefaultValues(ChunkedSegmentStorageConfig config) {
        ...
        Assert.assertEquals(config.getReadBlockSize(), ChunkedSegmentStorageConfig.DEFAULT_CONFIG.getReadBlockSize());
    }
