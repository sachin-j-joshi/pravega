...
public class FileSystemChunkStorageProvider extends BaseChunkStorageProvider {
     ...
     */
    public FileSystemChunkStorageProvider(FileSystemStorageConfig config) {
    ...
    protected ChunkHandle doOpenRead(String chunkName) throws ChunkStorageException, IllegalArgumentException {
        ...
        if (!Files.exists(path)) {
            throw new ChunkNotFoundException(chunkName, "FileSystemChunkStorageProvider::doOpenRead");
        }
    ...
    protected ChunkHandle doOpenWrite(String chunkName) throws ChunkStorageException, IllegalArgumentException {
        Path path = Paths.get(config.getRoot(), chunkName);
        if (!Files.exists(path)) {
            throw new ChunkNotFoundException(chunkName, "FileSystemChunkStorageProvider::doOpenWrite");
