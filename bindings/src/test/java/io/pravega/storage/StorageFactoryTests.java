...
public class StorageFactoryTests {
    ...
    public void testHDFSStorageFactoryCreator() {
        ...
        Storage storage1 = ((HDFSSimpleStorageFactory) factory1).createStorageAdapter(new InMemoryMetadataStore(Executors.newSingleThreadExecutor()));
    ...
    public void testExtendedS3StorageFactoryCreator() {
        ...
        Storage storage1 = ((ExtendedS3SimpleStorageFactory) factory1).createStorageAdapter(new InMemoryMetadataStore(Executors.newSingleThreadExecutor()));
        Assert.assertTrue(storage1 instanceof ChunkedSegmentStorage);
    ...
    public void testFileSystemStorageFactoryCreator() {
        ...
        Storage storage1 = ((FileSystemSimpleStorageFactory) factory1).createStorageAdapter(new InMemoryMetadataStore(Executors.newSingleThreadExecutor()));
        Assert.assertTrue(storage1 instanceof ChunkedSegmentStorage);
